...
export const getTrainIdFromProps = (_: AppState, props: {
  abfahrt: Abfahrt
}) => props.abfahrt.trainId;
export const getStation = (state: AppState) => state.abfahrten.currentStation;
export const getAuslastungForId = createSelector([getAuslastung, getTrainIdFromProps], (auslastung, trainId) => auslastung[trainId]?.data);
export const getAuslastungForIdAndStation = createSelector([getAuslastungForId, getStation], (auslastung: ?AuslastungEntry[], station: ?Station) => {
